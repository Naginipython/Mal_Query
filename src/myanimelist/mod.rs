...
lazy_static! {
    ...
    static ref CLIENT_ID: String = String::from("f7e5c56ef3561bb0a290a13d35b02c0b");
    static ref TOKEN: Mutex<String> = Mutex::new(fs::read_to_string("token.txt").unwrap_or_default());
}
